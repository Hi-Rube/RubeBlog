...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */(function(global,factory){ true?module.exports=factory():typeof define==='function'&&define.amd?define(factory):global.Vue=factory();})(undefined,function(){'use strict';function set(obj,key,val){if(hasOwn(obj,key)){obj[key]=val;return;}if(obj._isVue){set(obj._data,key,val);return;}var ob=obj.__ob__;if(!ob){obj[key]=val;return;}ob.convert(key,val);ob.dep.notify();if(ob.vms){var i=ob.vms.length;while(i--){var vm=ob.vms[i];vm._proxy(key);vm._digest();}}return val;}/**
	...
	if(!props||!hasOwn(props,key)||runtimeData&&hasOwn(runtimeData,key)&&props[key].raw===null){this._proxy(key);}else if(true){warn('Data field "'+key+'" is already defined '+'as a prop. Use prop default value instead.');}}// observe data
	observe(data,this);};/**
	...
	this.$off();};}function miscMixin(Vue){/**
	     ...
	     * @param {String|Function} value
	     * @param {Function} cb
	     */Vue.prototype._resolveComponent=function(value,cb){var factory;if(typeof value==='function'){factory=value;}else{factory=resolveAsset(this.$options,'components',value);if(true){assertAsset(factory,'component',value);}}if(!factory){return;}// async component factory
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] public/js/vue/app.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _daily = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] public/js/vue/daily.vue: named exports in *.vue files are ignored.")}
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        onSelectDaily: function onSelectDaily(day) {
	            ...
	            fetch(`daily/full?time=${ year }-${ month }-${ day }`).then(response => {
